...
public class LazyRegistryWithDCL {
    ...
    // volatile forces the JVM to not cache the instance variable, ensuring visibility across threads
    // It forces value read/write from main memory instead of thread-local cache
